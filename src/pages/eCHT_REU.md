...
title: "eCHT REU 2023"
label: "electronic computational homotopy theory · summer 2023"
lede: "An online REU in homotopical combinatorics — the abstract homotopy theory of small categories."
---

The 2023 [eCHT REU](https://s.wayne.edu/echt/reu-2023/) was an online Research Experience for Undergraduates supported by the NSF and led by [Kyle Ormsby](/bio/) and [Christy Hazel](https://www.math.ucla.edu/~chazel/) (with assistance from [Scotty Tilton](https://mathweb.ucsd.edu/~stilton/)). Between June 12 and July 21, we researched problems in *homotopical combinatorics*, a field that studies the abstract homotopy theory of small categories.

Below you can find our [schedule](#schedule), a list of [resources](#resources) for the program, and a [problem list](#problems).

## schedule

<sub>All times US Pacific Daylight ([UTC−07:00](https://www.timeanddate.com/worldclock/timezone/utc-7)). We observed the Juneteenth (June 19) and Independence Day (July 4) holidays, so no meetings those days.</sub>
...
- Hill, [Equivariant chromatic localizations and commutativity](https://arxiv.org/abs/1708.03017)
    - The effect of Bousfield localization on norms / transfer systems.
...
- ✹ Blog: [Homotopical combinatorics – an introduction for combinatorialists](/writing/homotopical-combinatorics/)
- Slides: [Transfer Systems and Model Structures for Combinatorialists](/files/UW_Combo.pdf)
- Slides: [Homotopical Combinatorics](/files/UW_Htpy_Combo.pdf) (and [video](https://youtu.be/UNDN5gUTPZY))
