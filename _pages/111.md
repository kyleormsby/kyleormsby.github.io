...
**Friday**: [HW due](/files/111fall25/hw/week11.pdf), [Integration by parts](https://activecalculus.org/single2e/sec-5-4-parts.html)

## week 12

**Monday**: [Other options for finding algebraic antiderivatives](https://activecalculus.org/single2e/sec-5-5-other-opt.html)

**Wednesday**: [Using definite integrals to find area and length](https://activecalculus.org/single2e/sec-6-1-area.html), [demo 1](https://www.desmos.com/calculator/68zu40vrtm), [demo 2](https://www.desmos.com/calculator/g00iut3j2g), [demo 3](https://www.desmos.com/calculator/z56439i40x), [integration in sage](https://doc.sagemath.org/html/en/reference/calculus/sage/symbolic/integration/integral.html), [sage cell server](https://sagecell.sagemath.org/)

**Friday**: Thanksgiving break 🦃

## week 13

**Monday**: [Using definite integrals to find volume](https://activecalculus.org/single2e/sec-6-2-volume.html), [demo 1](https://www.desmos.com/3d/hc1umz8sj4), [demo 2](https://www.desmos.com/3d/2ws5ykfhy4), [demo 3](https://www.desmos.com/3d/oje0azbqeb)

**Wednesday**: [Density, mass, and center of mass](https://activecalculus.org/single2e/sec-6-3-mass.html)

**Friday**: Quiz (IR.1, IR.2, IR.3)

## week 14

**Monday**: A glimpse of Taylor series, [demo](https://www.desmos.com/calculator/utqof8496v)

**Wednesday**: Student choice + course evaluations (bring your laptop 💻)

**Friday**: Reading period 📚 (optional review session 13:40-14:30 in Lib 204)
